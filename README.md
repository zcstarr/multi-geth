...
| Ticker | Network/Client                        | ethoxy/multi-geth                                | [ethereumproject/go-ethereum](https://github.com/ethereumproject/go-ethereum) | [ethereumclassic/go-ethereum](https://github.com/ethereumclassic/go-ethereum) | [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) |
| ---    | ---                                   | ---                                              | ---                                                                           | ---                                                                           | ---                                                             |
| ETH    | Ethereum (Foundation)                 | :heavy_check_mark:                               |                                                                               |                                                                               | :heavy_check_mark:                                              |
| ETC    | Ethereum Classic                      | :heavy_check_mark:                               | :heavy_check_mark:                                                            | :heavy_check_mark:                                                            |                                                                 |
...
| MUSIC  | Musicoin                              |                                                  |                                                                               |                                                                               |                                                                 |
|        | Morden (Geth+Parity ETH PoW Testnet)  |                                                  | :heavy_check_mark:                                                            | :heavy_check_mark:                                                            |                                                                 |
...
|        | Private chains                        | :heavy_check_mark:                               | :heavy_check_mark:                                                            | :heavy_check_mark:                                                            | :heavy_check_mark:                                              |
